...
$sport1 = "https://www.thesportsdb.com/league/4414-English-Premiership-Rugby";
$sport2 = "https://www.thesportsdb.com/league/4446-United-Rugby-Championship";
$sport3 = "https://www.thesportsdb.com/league/4986-Rugby-Championship";
$sport4 = "https://www.thesportsdb.com/league/4714-Six-Nations-Championship";
...
<head>
    ...
    <style>
        body
           {
            background-image: url('https://g-manmods.co.uk/GMANSPORT/images/rugbyworld.jpg');
...
if ($sport1)
{
    ...
    echo "<p>English-Premiership not found.</p>";
}

echo "  <h1>United-Rugby-Championship</h1>";
...
if ($sport2) {
    ...
    echo "<p>United-Rugby-Championship not found</p>";
}

echo "  <h1>Rugby-Championship</h1>";

$sport3 = $sport3_dom->getElementsByTagName('table')->item(0);
if ($sport3) {
    echo $sport3_dom->saveHTML($sport3);
} else {
    echo "<p>Rugby-Championship not found</p>";
}

echo "  <h1>Six-Nations-Championship</h1>";

$sport4 = $sport4_dom->getElementsByTagName('table')->item(0);
if ($sport4) {
    echo $sport4_dom->saveHTML($sport4);
} else {
    echo "<p>Six-Nations-Championship</p>";
}
