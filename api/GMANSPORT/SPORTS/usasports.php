...
$sport1 = "https://www.thesportsdb.com/league/4391-NFL";
$sport2 = "https://www.thesportsdb.com/league/4424-MLB";
$sport3 = "https://www.thesportsdb.com/league/4387-NBA";
$sport4 = "https://www.thesportsdb.com/league/4380-NHL";
...
<head>
    ...
    <style>
        body  {
            background-image: url('https://g-manmods.co.uk/GMANSPORT/images/nfl2.jpg');
...
<body>
    <div class='container'>
        <h1>NFL Fixtures and Results</h1>";
...
if ($sport1)
{
    ...
    echo "<p>NFL Fixtures not found.</p>";
}

echo "  <h1>MLB Fixtures and Results</h1>";
...
if ($sport2) {
    ...
    echo "<p>MLB Fixtures not Loaded</p>";
}

echo "  <h1>NBA fixtures and Results</h1>";

$sport3 = $sport3_dom->getElementsByTagName('table')->item(0);
if ($sport3) {
    echo $sport3_dom->saveHTML($sport3);
} else {
    echo "<p>NBA fixtures Not Loaded</p>";
}

echo "  <h1>NHL Fixtures and Results</h1>";

$sport4 = $sport4_dom->getElementsByTagName('table')->item(0);
if ($sport4) {
    echo $sport4_dom->saveHTML($sport4);
} else {
    echo "<p>NHL Fixtures Not Loaded</p>";
}
